...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api-mygram-go_comment_utils.ResponseMessage"
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/api-mygram-go_photo_utils.ResponseMessage"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/api-mygram-go_socialmedia_utils.ResponseMessage"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/utils.ResponseGetAllUsers"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/api-mygram-go_user_utils.ResponseMessage"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        "api-mygram-go_comment_utils.ResponseMessage": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "string",
        ...
        "api-mygram-go_comment_utils.User": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "api-mygram-go_photo_utils.ResponseMessage": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "string",
        ...
        "api-mygram-go_photo_utils.User": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
        ...
        "api-mygram-go_socialmedia_utils.ResponseMessage": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "string",
        ...
        "api-mygram-go_socialmedia_utils.User": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
        ...
        "api-mygram-go_user_utils.ResponseMessage": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "string",
        ...
        "utils.FetchedComment": {
            ...
            "properties": {
                ...
                "user": {
                    "$ref": "#/definitions/api-mygram-go_comment_utils.User"
                },
                "user_id": {
                    "type": "string"
                }
        ...
        "utils.FetchedPhoto": {
            ...
            "properties": {
                ...
                "user": {
                    "$ref": "#/definitions/api-mygram-go_photo_utils.User"
                },
                "user_id": {
                    "type": "string"
                }
        ...
        "utils.ResponseGetAllUsers": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/utils.Users"
                },
                "status": {
                    "type": "string",
                    "example": "success"
        ...
        "utils.SocialMedia": {
            ...
            "properties": {
                ...
                "user": {
                    "$ref": "#/definitions/api-mygram-go_socialmedia_utils.User"
                },
                "user_id": {
                    "type": "string",
                    "example": "here is the generated user id"
